...
$(document).ready(function(){
  $('.filter-all-block').bind('click', function(){
    window.location.replace('http://localhost:3005/web/feed/FeedManagement?p=1&ps='+$('#pagesize-block').text());
  });

  $('.filter-show-block').bind('click', function(){
    window.location.replace('http://localhost:3005/web/feed/FeedManagement?p=1&ps='+$('#pagesize-block').text()+'&opt=1');
  });

  $('.filter-hide-block').bind('click', function(){
    window.location.replace('http://localhost:3005/web/feed/FeedManagement?p=1&ps='+$('#pagesize-block').text()+'&opt=0');
  });
